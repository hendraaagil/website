...
Hooks `useEffect` ini akan berjalan saat pertama render dan saat terdapat sebuah re-render / pembaruan di komponennya. Sebagai contoh, kita akan melanjutkan project di blog [ini](https://hendraaagil.dev/blog/berkenalan-dengan-react) kemarin.
