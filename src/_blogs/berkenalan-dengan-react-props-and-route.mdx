...
Props biasanya kita gunakan untuk melempar data antar komponen. Sebagai contoh, pada project di blog [ini](https://hendraaagil.id/blog/berkenalan-dengan-react) kemarin. Kita akan coba pisahkan komponen nama dari `App`, sehingga isi file `App.js` akan seperti berikut:
